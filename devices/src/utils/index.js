...
module.exports.ValidateSignature = async (req) => {
    try {
        ...
        if (signature.indexOf("Bearer") == -1) return false
        if (signature.split(" ")[1] == null) return false
        if (signature.split(" ")[1] == "undefined") return false
...
module.exports.ValidateSignatureSocket = async (socket) => {
    try {
        let signature = socket.handshake.query.token;
        //console.log(signature);
        if (signature == null) return false
